...
use App\Repository\FactureComptabiliteRepository;

#[ORM\Entity(repositoryClass: FactureComptabiliteRepository::class)]
class FactureComptabilite
{
    const MODE_RGLT = [
        //'Non precisé' => '',
        //'par LCR' => 'lcr',
    ...
    #[ORM\ManyToOne(inversedBy: 'factureComptabilites')]
    ...
    public function setComptabilite(?Comptabilite $comptabilite): static
    {
