...
use App\Repository\FactureDepenseRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: FactureDepenseRepository::class)]
class FactureDepense
{
    const MODE_RGLT = [
        //'Non precisé' => '',
        //'par LCR' => 'lcr',
    ...
    #[ORM\ManyToOne(inversedBy: 'factureDepenses')]
    private ?Application $application = null;

    /**
     * @var Collection<int, Depense>
     */
    #[ORM\ManyToMany(targetEntity: Depense::class, inversedBy: 'factureDepenses')]
